  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-lg": ["clamp(3rem, 8vw, 9rem)", { lineHeight: "0.95", letterSpacing: "-0.02em" }],
        "display-md": ["clamp(2rem, 5vw, 6rem)", { lineHeight: "1", letterSpacing: "-0.01em" }],
        "display-sm": ["clamp(1.5rem, 3vw, 3.5rem)", { lineHeight: "1.1" }],
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
